...
if (isset($_POST['search']) ) {
	...
	$sokeord = $_POST['sokKommune'];
	$sokeord = "%" . $sokeord . "%";
	$statement = $db->prepare("SELECT id, arkivskaper, status, startDato, 
 sluttDato, saksNR, mottattDATO,forventetAnkomst, system, ansvarlig, sistendret FROM uttrekk WHERE arkivskaper LIKE ? ORDER BY startDato ASC");
